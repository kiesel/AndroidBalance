...
public class EditAccountActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Fill spinner values
        ArrayAdapter<CharSequence> adapter= ArrayAdapter.createFromResource(this, R.array.edit_account_hbciversions, R.id.edit_account_hbciver);
